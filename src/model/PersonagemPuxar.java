 ...
 * @author Aners
 */
public class PersonagemPuxar extends Personagem{

    public PersonagemPuxar(int jogador, int alcance, int movimentacao, int forcaAtaque, int vida, int frente, int costas, int esquerda, int direita, int custoVP, String nome, int x, int y) {
